...
NSString *  const kBDADSignalSDKUserUniqueId = @"user_unique_id";

NSString *  const kBDADSignalSDKEventStayTime = @"stay_time";
NSString *  const kBDADSignalSDKEventRegister = @"register";
NSString *  const kBDADSignalSDKEventPurchase = @"purchase";
NSString *  const kBDADSignalSDKEventGameAddiction = @"game_addiction";

NSString *  const kBDADSignalSDKVersion = @"1.0.6";
