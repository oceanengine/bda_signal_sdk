...
GPBObjCClassDeclaration(BDASignalEvent);
...
static GPBFileDescription BDASignalBdasignalRequestModelRoot_FileDescription = {
  .package = NULL,
  .prefix = "BDASignal",
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(BDASignalEvent)
                                   messageName:@"Event"
                               fileDescription:&BDASignalBdasignalRequestModelRoot_FileDescription
                                        fields:fields
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(BDASignalUser)
                                   messageName:@"User"
                               fileDescription:&BDASignalBdasignalRequestModelRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(BDASignalHeader)
                                   messageName:@"Header"
                               fileDescription:&BDASignalBdasignalRequestModelRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
